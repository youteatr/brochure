						...
						<div className="form__label-content">
							<div className="direction__info">
								<div className="direction__head">
									...
									<span className='text text_size_large text_transform_uppercase text_weight_medium no-select'>{t('global.prices.enroll-' + props.mode + '.david')} {t('global.cost-per-month')}</span>
								</div>
						...
						<div className="form__label-content">
							<div className="direction__info">
								<div className="direction__head">
									...
									<span className='text text_size_large text_transform_uppercase text_weight_medium no-select'>{t('global.prices.enroll-' + props.mode + '.ursula')} {t('global.cost-per-month')}</span>
								</div>
								<div className="direction__description">
